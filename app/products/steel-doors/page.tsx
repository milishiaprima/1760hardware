...
export default function SteelDoors() {
  const doorProducts = [
    {
      id: 1,
      name: 'Heavy-Duty Steel Exterior Door',
    ...
    },
    {
      ...
      description: 'Contemporary steel doors combining style with superior security and durability',
    ...
    {
      id: 3,
      name: 'Premium Security Steel Door',
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-block mb-4 px-4 py-2 bg-red-500/20 rounded-full border border-red-400/40 backdrop-blur">
              <p className="text-red-200 text-sm font-bold uppercase tracking-wide">Premium Collection</p>
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">
              Premium <span className="text-red-400">Steel Doors</span>
            </h1>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4">Our Steel Door Collections</h2>
