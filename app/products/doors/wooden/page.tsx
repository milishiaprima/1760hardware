  ...
  const doorProducts = [
    {
      ...
      description: 'Timeless wooden doors with natural finish and elegant design',
    ...
    },
    {
      ...
      description: 'Contemporary wooden doors with sleek design and premium finishes',
    ...
    {
      id: 3,
      name: 'Premium Wooden Door Set',
      description: 'High-end wooden doors complete with premium hardware and fixtures',
      image: '/doors/home%20door.jpg',
      rating: '4.7',
      features: [
        'Includes hardware',
    ...
    <>
      ...
      <section className="bg-gray-100 py-4 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <Link href="/products/doors" className="inline-flex items-center gap-2 text-orange-600 hover:text-orange-700">
            <ChevronLeft size={18} />
      ...
      {/* Hero Section */}
      <section className="relative py-16 sm:py-24 md:py-32 overflow-hidden bg-linear-to-br from-slate-950 via-orange-950 to-slate-900">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-block mb-4 px-4 py-2 bg-orange-500/20 rounded-full border border-orange-400/40 backdrop-blur">
              <p className="text-orange-200 text-sm font-bold uppercase tracking-wide">Premium Collection</p>
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">
              Premium <span className="text-orange-400">Wooden Doors</span>
            </h1>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Elegant wooden doors crafted with precision and built to enhance your spaces with timeless beauty and quality.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4">Our Wooden Door Collections</h2>
            <p className="text-lg text-gray-600">Premium quality doors for every space</p>
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg text-gray-600">What makes our wooden doors stand out</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-8 rounded-xl border border-gray-200 hover:border-orange-300 transition-colors">
              <div className="text-4xl mb-4">🌳</div>
              <h3 className="text-xl font-bold text-slate-900 mb-2">Premium Wood</h3>
              <p className="text-gray-600 text-sm">Selected quality wood for durability and aesthetics</p>
            </div>

            <div className="bg-white p-8 rounded-xl border border-gray-200 hover:border-orange-300 transition-colors">
              <div className="text-4xl mb-4">🎨</div>
              <h3 className="text-xl font-bold text-slate-900 mb-2">Fine Finishes</h3>
            ...
            <div className="bg-white p-8 rounded-xl border border-gray-200 hover:border-orange-300 transition-colors">
              <div className="text-4xl mb-4">📦</div>
              <h3 className="text-xl font-bold text-slate-900 mb-2">Safe Delivery</h3>
              <p className="text-gray-600 text-sm">Secure packaging and reliable transportation</p>
            </div>
          </div>
        </div>
      </section>
