  ...
  const doorProducts = [
    {
      ...
      description: 'Timeless wooden interior doors with natural finish and elegant design',
    ...
    {
      id: 3,
      name: 'Premium Wooden Door with Hardware',
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Elegant wooden interior doors crafted with precision and built to enhance your spaces with timeless beauty and quality.
            </p>
          </div>
        </div>
      </section>
